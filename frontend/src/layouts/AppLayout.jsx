...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-pattern px-4 py-6 sm:px-8">
      <header className="mx-auto mb-6 flex max-w-7xl flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/40 bg-white/70 p-4 shadow-sm backdrop-blur">
        <div>
